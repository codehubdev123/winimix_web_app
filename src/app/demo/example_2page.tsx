...
export default function PremiumAgencyHomepage() {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <header className="fixed w-full z-40 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md py-4 shadow-sm border-b border-gray-200/30 dark:border-gray-700/30">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <div
                key={project.id}
                className="group rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 animate-fade-in-up"
                style={{ animationDelay: `${index * 100}ms` }}
              >
                ...
                <div className="p-5 bg-white dark:bg-gray-800">
                  ...
                  <h3 className="font-semibold text-lg mt-1 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">
                    {project.title}
                  </h3>
                </div>
              </div>
          ...
          <div className="text-center mt-12">
            <button className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-8 py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl flex items-center mx-auto group">
