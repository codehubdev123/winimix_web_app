...
export default function NewFooter() {
  return (
    <footer className="bg-[#222934] text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 rtl:space-x-reverse">
              <Facebook className="w-5 h-5 text-white hover:underline cursor-pointer" />
              <Twitter className="w-5 h-5 text-white hover:underline cursor-pointer" />
              <Instagram className="w-5 h-5 text-white hover:underline cursor-pointer" />
              <Youtube className="w-5 h-5 text-white hover:underline cursor-pointer" />
            </div>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="x-border-t mt-8 pt-8 text-center">
