...
export const Details: React.FC<DetailsProps> = ({ category }) => {
            ...
            <div className="flex items-start space-x-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  >
                    <Star
                      className={`h-3 w-3 mr-1 ${category.isFeatured ? "fill-current" : ""}`}
                    />
          ...
          <div className="">
            <div className="flow-root">
              <dl className=" divide-y divide-gray-200 rounded border border-gray-200 text-md *:even:bg-gray-50">
                ...
                <DetailsItem name={"Name"}>{category.name?.en}</DetailsItem>
