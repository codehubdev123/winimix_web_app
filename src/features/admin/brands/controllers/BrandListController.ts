...
export class BrandListController extends BaseController {
  constructor() {
    super();
  }
  ...
  public async execute(req: NextRequest) {
    try {
      ...
      let query = adminDb.collection(brandCollection);
      ...
      console.log(`✅ Found ${brands.length} brands out of ${total} total`);
